...
pgn | x | x | Well-known sequence of moves, or the most common moves leading to the opening position based on master games, in PGN
...
This dataset is also [available in Apache Parquet format](https://hf.co/datasets/Lichess/chess-openings).
